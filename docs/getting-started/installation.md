...
Because the distribution archive is quite large (8GB), it cannot be hosted using GitHub releases.
...
Continue with [User Guide](../user-guide/overview.md) to learn about all the features.

## For Developers

For development setup and building from source, see [Building from Source](../development/building.md).
